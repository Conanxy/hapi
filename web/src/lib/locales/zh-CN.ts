export default {
  ...
  'settings.chat.escapeBehavior': 'Esc 中断任务',
  'settings.chat.escapeBehavior.double': '按两次（默认）',
  'settings.chat.escapeBehavior.single': '按一次',
  'chat.escapeAbort.title': '中断当前任务？',
  'chat.escapeAbort.body': '2 秒内再次按 Esc 可中断当前任务。',
