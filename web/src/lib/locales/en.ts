export default {
  ...
  'settings.chat.escapeBehavior': 'Esc to interrupt task',
  'settings.chat.escapeBehavior.double': 'Press twice (default)',
  'settings.chat.escapeBehavior.single': 'Press once',
  'chat.escapeAbort.title': 'Interrupt current task?',
  'chat.escapeAbort.body': 'Press Esc again within 2 seconds to interrupt the current task.',
